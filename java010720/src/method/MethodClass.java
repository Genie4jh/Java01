...
public class MethodClass {
	...
	// 매개변수가 정수 1개이고 리턴 타입이 void 인 메소드
	// 이 메소드는 호출하려면 반드시 정수 1개를 넘겨주어야 합니다. 
	...
	// 정수 1개를 매개변수로 받아서 1증가시키고 출력하는 메솓: Call By Value
	...
	// 2개의 정수를 매개변수로 받아서 더한 후 결과를 '출력'하는 메소드
	public void addDisplay(int a, int b) {
		System.out.println("a+b:" + (a+b));
		
	}
	
	// 2개의 정수를 매개변수로 받아서 더한 후 결과를 '리턴'하는 메소드
